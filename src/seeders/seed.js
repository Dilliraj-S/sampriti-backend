...
const seed = async () => {
  try {
    ...
    await Product.bulkCreate([
      {
        id: 1, name: 'Shakti Peya', slug: 'shakti-peya', subtitle: 'The Elixir of Vitality',
        categoryId: 1, price: 1850, stock: 50,
        description: 'A potent adaptogenic brew rooted in the ancient Siddha tradition...',
        image: '/assets/shakti peya product hd.webp',
        hoverImage: '/assets/shakti peya hover.webp',
      ...
      },
      {
        ...
        image: '/assets/Chandra rasa product hd.webp',
        hoverImage: '/assets/chandra rasa hover.webp',
