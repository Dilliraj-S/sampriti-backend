    ...
    await Product.bulkCreate([
      {
        ...
        image: '/assets/products/shakti peya product hd.png',
        hoverImage: '/assets/products/shakti peya hover.png',
      ...
      },
      {
        ...
        image: '/assets/products/hibiscus hd.png',
        hoverImage: '/assets/products/hibiscus hover.png',
